import { globalSearch, ATTR_ATK_CN, ATTR_CN, getData } from '../store.js';
  ...
  return `
    <div class="item-card" data-key="${item._key}" data-id="${item.id}">
      <div class="item-card-header">
        <div class="item-card-category" style="font-size:0.65rem;color:var(--accent-gold);margin-bottom:2px">${item._type}</div>
