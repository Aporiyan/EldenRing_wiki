import { getData, getCategories, ATTR_ATK_CN, ATTR_CN, translateName, scalingGrade, getUpgradeInfo, getCategoryGroup, getCategorySub, getCategoryGroups, getGroupSubs } from '../store.js';
